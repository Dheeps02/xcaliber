...
import { MapPin, ArrowLineUp, ArrowLineDown, Info, CaretUp } from '@phosphor-icons/react';
          ...
          <div className="flex items-end gap-2 px-3.5 py-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="xcb-input px-2 font-mono text-xs focus:outline-none"
                  style={{
                    width: 148,
                    color: 'transparent',
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="xcb-input no-spinner px-2 font-mono text-xs text-center focus:outline-none"
                style={{ width: 48 }}
                onFocusCapture={(e) => ((e.currentTarget as HTMLElement).style.borderColor = 'var(--accent)')}
                onBlurCapture={(e) => ((e.currentTarget as HTMLElement).style.borderColor = '')}
              />
            ...
            <div className="flex flex-col gap-1 flex-1 min-w-0">
              ...
              <div className="relative">
                <input
                  ...
                  className="xcb-input w-full px-2 font-mono text-xs focus:outline-none"
                  style={{
