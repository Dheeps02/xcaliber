...
const themes = [
  { name: 'Nord',            colors: ['#88C0D0','#5E81AC','#BF616A'], bg: '#2E3440', fg: '#D8DEE9' },
  { name: 'Catppuccin Mocha',colors: ['#CBA6F7','#89B4FA','#A6E3A1'], bg: '#1E1E2E', fg: '#CDD6F4' },
  { name: 'Gruvbox Dark',    colors: ['#FABD2F','#B8BB26','#FB4934'], bg: '#282828', fg: '#EBDBB2' },
  { name: 'Tokyo Night',     colors: ['#7AA2F7','#BB9AF7','#9ECE6A'], bg: '#1A1B26', fg: '#C0CAF5' },
  { name: 'Dracula',         colors: ['#BD93F9','#50FA7B','#F1FA8C'], bg: '#282A36', fg: '#F8F8F2' },
  { name: 'One Dark',        colors: ['#61AFEF','#98C379','#E5C07B'], bg: '#282C34', fg: '#ABB2BF' },
  { name: 'Everforest',      colors: ['#A7C080','#83C092','#E69875'], bg: '#2D353B', fg: '#D3C6AA' },
  { name: 'Rosé Pine',       colors: ['#EBBCBA','#C4A7E7','#9CCFD8'], bg: '#191724', fg: '#E0DEF4' },
  { name: 'Monokai',         colors: ['#A6E22E','#F92672','#E6DB74'], bg: '#272822', fg: '#F8F8F2' },
  { name: 'OLED',            colors: ['#FFFFFF','#888888','#444444'], bg: '#000000', fg: '#FFFFFF' },
]
</script>
  ...
  <div class="zs-root">
    ...
    <nav class="zs-nav" :class="{ 'zs-nav--hidden': !navVisible }">
      ...
      <div class="zs-nav-links">
        <a href="/guide/getting-started" class="zs-nav-link">
          <svg width="13" height="13" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M208,24H72A32,32,0,0,0,40,56V224a8,8,0,0,0,8,8H192a8,8,0,0,0,0-16H56a16,16,0,0,1,16-16H208a8,8,0,0,0,8-8V32A8,8,0,0,0,208,24Zm-8,160H72a31.8,31.8,0,0,0-16,4.29V56A16,16,0,0,1,72,40H200Z"/></svg>
          Docs
        </a>
        <a href="/features/daq" class="zs-nav-link">
          <svg width="13" height="13" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M215.79,118.17a8,8,0,0,0-5-5.66L153.18,90.9l14.66-73.33a8,8,0,0,0-13.69-7l-112,120a8,8,0,0,0,3,13l57.63,21.61L88.16,238.43a8,8,0,0,0,13.69,7l112-120A8,8,0,0,0,215.79,118.17Z"/></svg>
          Features
        </a>
        <a href="/reference/rest-api" class="zs-nav-link">
          <svg width="13" height="13" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M69.12 94.15 28.5 128l40.62 33.85a8 8 0 1 1-10.24 12.29l-48-40a8 8 0 0 1 0-12.29l48-40a8 8 0 0 1 10.24 12.3Zm176 27.71-48-40a8 8 0 1 0-10.24 12.29L227.5 128l-40.62 33.85a8 8 0 1 0 10.24 12.29l48-40a8 8 0 0 0 0-12.28Zm-82.39-89.63a8 8 0 0 0-10.25 4.77l-64 176a8 8 0 0 0 4.77 10.25A7.77 7.77 0 0 0 96 224a8 8 0 0 0 7.52-5.23l64-176a8 8 0 0 0-4.79-10.54Z"/></svg>
          API
        </a>
        <a href="/reference/contributing" class="zs-nav-link">
          <svg width="13" height="13" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M208.31 75.68A59.78 59.78 0 0 0 202.93 28a8 8 0 0 0-6.93-4 59.75 59.75 0 0 0-48 24h-24a59.75 59.75 0 0 0-48-24 8 8 0 0 0-6.93 4 59.78 59.78 0 0 0-5.38 47.68A58.14 58.14 0 0 0 56 104v8a56.06 56.06 0 0 0 48.44 55.47A39.8 39.8 0 0 0 96 192v8H72a24 24 0 0 1-24-24 40 40 0 0 0-40-40 8 8 0 0 0 0 16 24 24 0 0 1 24 24 40 40 0 0 0 40 40h24v16a8 8 0 0 0 16 0v-40a24 24 0 0 1 48 0v40a8 8 0 0 0 16 0v-40a39.8 39.8 0 0 0-8.44-24.53A56.06 56.06 0 0 0 216 112v-8a58.14 58.14 0 0 0-7.69-28.32Z"/></svg>
          Contributing
        </a>
      </div>
      <div class="zs-nav-actions">
        ...
        <a href="/guide/getting-started" class="zs-btn-download">
          <svg width="13" height="13" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M240 136v64a16 16 0 0 1-16 16H32a16 16 0 0 1-16-16v-64a16 16 0 0 1 16-16h48a8 8 0 0 1 0 16H32v64h192v-64h-48a8 8 0 0 1 0-16h48a16 16 0 0 1 16 16Zm-114.34-61.66a8 8 0 0 1 10.68 0l40 40a8 8 0 0 1-11.31 11.31L136 96.69V176a8 8 0 0 1-16 0V96.69l-29.03 29.0a8 8 0 0 1-11.31-11.31Z"/></svg>
          Download
        </a>
      </div>
    </nav>
    ...
    <section class="zs-hero">
      ...
      <div class="zs-hero-content">
        ...
        <p class="zs-hero-sub">
          ZenScope is an open-source client for the <a href="https://www.asam.net/standards/detail/mcd-1-xcp/" target="_blank" rel="noopener" class="zs-hero-xcp-link">ASAM XCP protocol</a> — the industry standard for automotive ECU calibration and measurement. Live DAQ, packet tracing, REST API — all in one desktop app.
        </p>
    ...
    <section class="zs-features">
      <div class="zs-container">
        <div class="zs-section-eyebrow">
          <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M215.79,118.17a8,8,0,0,0-5-5.66L153.18,90.9l14.66-73.33a8,8,0,0,0-13.69-7l-112,120a8,8,0,0,0,3,13l57.63,21.61L88.16,238.43a8,8,0,0,0,13.69,7l112-120A8,8,0,0,0,215.79,118.17Z"/></svg>
          Features
        </div>
        ...
        <div class="zs-features-grid">
          ...
          <a href="/features/daq" class="zs-feature-card">
          ...
          <a href="/features/trace" class="zs-feature-card">
            <div class="zs-feature-icon">
          ...
          <a href="/reference/architecture" class="zs-feature-card">
            <div class="zs-feature-icon">
            ...
            <h3 class="zs-feature-title">XCP over UDP</h3>
            <p class="zs-feature-desc">UDP socket and raw Ethernet transport modes, with configurable XCP-on-UDP settings. TCP support is planned for a future release.</p>
          </a>

          <a href="/guide/configuration" class="zs-feature-card">
            <div class="zs-feature-icon">
          ...
          <a href="/reference/rest-api" class="zs-feature-card">
            <div class="zs-feature-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" width="22" height="22"><path d="M215.79,118.17a8,8,0,0,0-5-5.66L153.18,90.9l14.66-73.33a8,8,0,0,0-13.69-7l-112,120a8,8,0,0,0,3,13l57.63,21.61L88.16,238.43a8,8,0,0,0,13.69,7l112-120A8,8,0,0,0,215.79,118.17Z"/></svg>
            </div>
    ...
    <section class="zs-showcase-split">
      <div class="zs-container zs-showcase-split-inner">
        <div class="zs-showcase-copy">
          <div class="zs-section-eyebrow">
            <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M208,136H48a16,16,0,0,0-16,16v40a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V152A16,16,0,0,0,208,136Zm0,56H48V152H208v40Zm0-144H48A16,16,0,0,0,32,64v40a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V64A16,16,0,0,0,208,48Zm0,56H48V64H208v40Z"/></svg>
            Packet Trace
          </div>
    ...
    <section class="zs-arch">
      <div class="zs-container">
        <div class="zs-section-eyebrow">
          <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M69.12 94.15 28.5 128l40.62 33.85a8 8 0 1 1-10.24 12.29l-48-40a8 8 0 0 1 0-12.29l48-40a8 8 0 0 1 10.24 12.3Zm176 27.71-48-40a8 8 0 1 0-10.24 12.29L227.5 128l-40.62 33.85a8 8 0 1 0 10.24 12.29l48-40a8 8 0 0 0 0-12.28Z"/></svg>
          Architecture
        </div>
        <h2 class="zs-section-title">Frontend meets Rust</h2>
        <p class="zs-section-sub">A native Rust XCP engine runs as a sidecar process alongside the Electron shell — zero compromises on performance or hardware access.</p>

        <div class="zs-arch-diagram">
          <!-- Frontend -->
          <div class="zs-arch-box zs-arch-box-ui">
            <div class="zs-arch-box-header">
              <svg width="16" height="16" fill="currentColor" viewBox="0 0 256 256"><path d="M232,168h-8V72a16,16,0,0,0-16-16H48a16,16,0,0,0-16,16v96H24a8,8,0,0,0,0,16H208a8,8,0,0,0,0-16Zm-24 0H48V72h160Zm-64,24H112a8,8,0,0,1,0-16h32a8,8,0,0,1,0,16Z"/></svg>
              <span class="zs-arch-label">Electron Shell</span>
              <span class="zs-arch-lang">TypeScript + React</span>
            </div>
            <div class="zs-arch-items">
              <span class="zs-arch-item">DAQ View</span>
              <span class="zs-arch-item">Trace View</span>
              <span class="zs-arch-item">Command Bar</span>
              <span class="zs-arch-item">Settings</span>
              <span class="zs-arch-item">10+ Themes</span>
            </div>
          </div>

          <div class="zs-arch-arrow-col">
            <div class="zs-arch-conn">
              <svg width="32" height="12" fill="none" viewBox="0 0 32 12"><path d="M0 6h28M22 1l6 5-6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <span class="zs-arch-conn-label">IPC</span>
            </div>
            <div class="zs-arch-conn zs-arch-conn-rev">
              <svg width="32" height="12" fill="none" viewBox="0 0 32 12"><path d="M32 6H4M10 1 4 6l6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <span class="zs-arch-conn-label">REST / SSE</span>
            </div>
          </div>
          ...
          <div class="zs-arch-box zs-arch-box-core">
            <div class="zs-arch-box-header">
              <svg width="16" height="16" fill="currentColor" viewBox="0 0 256 256"><path d="M215.79,118.17a8,8,0,0,0-5-5.66L153.18,90.9l14.66-73.33a8,8,0,0,0-13.69-7l-112,120a8,8,0,0,0,3,13l57.63,21.61L88.16,238.43a8,8,0,0,0,13.69,7l112-120A8,8,0,0,0,215.79,118.17Z"/></svg>
              <span class="zs-arch-label">ZenScope Core</span>
              <span class="zs-arch-lang">Rust sidecar binary</span>
            </div>
            <div class="zs-arch-items">
              <span class="zs-arch-item zs-arch-item-accent">XCP Engine</span>
              <span class="zs-arch-item zs-arch-item-accent">REST API (HTTP)</span>
              <span class="zs-arch-item zs-arch-item-accent">SSE Stream</span>
              <span class="zs-arch-item zs-arch-item-accent">DAQ Scheduler</span>
              <span class="zs-arch-item zs-arch-item-accent">SQLite Logger</span>
            </div>
          </div>
          ...
          <div class="zs-arch-arrow-col">
            <div class="zs-arch-conn">
              <svg width="32" height="12" fill="none" viewBox="0 0 32 12"><path d="M0 6h28M22 1l6 5-6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <span class="zs-arch-conn-label">XCP/UDP</span>
            </div>
            <div class="zs-arch-conn zs-arch-conn-rev">
              <svg width="32" height="12" fill="none" viewBox="0 0 32 12"><path d="M32 6H4M10 1 4 6l6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
              <span class="zs-arch-conn-label">Raw Ethernet</span>
            </div>
          </div>
          ...
          <div class="zs-arch-box zs-arch-box-ecu">
            <div class="zs-arch-box-header">
              <svg width="16" height="16" fill="currentColor" viewBox="0 0 256 256"><path d="M200,168a8,8,0,0,1-8,8H152a8,8,0,0,1,0-16h40A8,8,0,0,1,200,168Zm-48-40h40a8,8,0,0,0,0-16H152a8,8,0,0,0,0,16Zm96-72V200a16,16,0,0,1-16,16H24a16,16,0,0,1-16-16V56A16,16,0,0,1,24,40H232A16,16,0,0,1,248,56ZM232,200V56H24V200H232Z"/></svg>
              <span class="zs-arch-label">Target ECU</span>
              <span class="zs-arch-lang">XCP Slave device</span>
            </div>
            <div class="zs-arch-items">
              <span class="zs-arch-item">Memory Maps</span>
              <span class="zs-arch-item">Calibration Data</span>
              <span class="zs-arch-item">Measurement Values</span>
            </div>
          </div>
        </div>
      ...
      <div class="zs-container">
        <div class="zs-api-inner">
          <div class="zs-api-copy">
            <div class="zs-section-eyebrow">
              <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M69.12 94.15 28.5 128l40.62 33.85a8 8 0 1 1-10.24 12.29l-48-40a8 8 0 0 1 0-12.29l48-40a8 8 0 0 1 10.24 12.3Zm176 27.71-48-40a8 8 0 1 0-10.24 12.29L227.5 128l-40.62 33.85a8 8 0 1 0 10.24 12.29l48-40a8 8 0 0 0 0-12.28Zm-82.39-89.63a8 8 0 0 0-10.25 4.77l-64 176a8 8 0 0 0 4.77 10.25A7.77 7.77 0 0 0 96 224a8 8 0 0 0 7.52-5.23l64-176a8 8 0 0 0-4.79-10.54Z"/></svg>
              REST API
            </div>
            ...
            <table class="zs-api-table">
              ...
              <tbody>
                <tr><td><span class="zs-method zs-get">GET</span></td><td><code>/api/daq/status</code></td><td>Session status &amp; rate</td></tr>
  ...
  -d <span class="zs-c-str">'{
    ...
    <section class="zs-themes">
      <div class="zs-container zs-themes-header">
        <div class="zs-section-eyebrow">
          <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M200.77,53.89A103.27,103.27,0,0,0,128,24h-1.07A104,104,0,0,0,24,128c0,43,26.58,79.06,69.36,94.17A32,32,0,0,0,136,192a16,16,0,0,1,16-16h46.21a31.81,31.81,0,0,0,31.2-24.88,104.43,104.43,0,0,0,2.59-24A103.28,103.28,0,0,0,200.77,53.89Z"/></svg>
          Themes
        </div>
        <h2 class="zs-section-title">Your workspace, your aesthetic</h2>
        <p class="zs-themes-sub">Ten-plus hand-tuned themes, switchable instantly — because calibration sessions run long.</p>
      </div>
      <div class="zs-marquee-wrap">
        <div class="zs-marquee">
          <template v-for="pass in 2" :key="pass">
            ...
            >
              <span class="zs-theme-swatches">
                <span v-for="c in theme.colors" :key="c" class="zs-theme-swatch" :style="{background: c}"></span>
              </span>
              <span class="zs-theme-name">{{ theme.name }}</span>
            </div>
          </template>
        </div>
      </div>
...
npm install &amp;&amp; cd frontend &amp;&amp; npm install &amp;&amp; cd ..</code></pre>
          ...
          <div class="zs-qs-step">
            ...
            <p class="zs-qs-desc">Electron + Vite start together. Hot reload on the frontend.</p>
          </div>
          <div class="zs-qs-step">
            <div class="zs-qs-num">03</div>
            <h3 class="zs-qs-title">Connect &amp; Measure</h3>
            <p class="zs-qs-desc">Point ZenScope at your XCP target — or use the bundled mock slave at <code>127.0.0.1:5555</code> if you don't have an ECU on hand.</p>
    ...
    <section class="zs-built-for">
      <div class="zs-container">
        <div class="zs-section-eyebrow">
          <svg width="12" height="12" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M117.25,157.92a60,60,0,1,0-66.5,0A95.83,95.83,0,0,0,3.53,195.63a8,8,0,1,0,13.4,8.74,80,80,0,0,1,134.14,0,8,8,0,0,0,13.4-8.74A95.83,95.83,0,0,0,117.25,157.92ZM40,108a44,44,0,1,1,44,44A44.05,44.05,0,0,1,40,108Zm210.14,98.7a8,8,0,0,1-11.07-2.33A79.83,79.83,0,0,0,172,168a8,8,0,0,1,0-16,44,44,0,1,0-16.34-84.87,8,8,0,1,1-5.94-14.85,60,60,0,0,1,55.53,105.64,95.83,95.83,0,0,1,47.22,37.71A8,8,0,0,1,250.14,206.7Z"/></svg>
          Built For
        </div>
        <h2 class="zs-section-title">Who uses ZenScope?</h2>
        <div class="zs-bf-grid">
          <a href="/guide/use-cases" class="zs-bf-card">
            ...
            <span class="zs-bf-link">View use cases →</span>
          </a>
          <a href="/reference/rest-api" class="zs-bf-card">
            <div class="zs-bf-icon">
            ...
            <span class="zs-bf-link">Read the API docs →</span>
          </a>
          <a href="/features/trace" class="zs-bf-card">
            <div class="zs-bf-icon">
            ...
            <span class="zs-bf-link">Explore packet trace →</span>
          </a>
        </div>
      </div>
    </section>
    ...
    <section class="zs-stack">
      <div class="zs-container">
        ...
        <div class="zs-stack-pills">
          ...
          <span class="zs-stack-pill">ASAM XCP</span>
          ...
          <div class="zs-footer-brand">
            ...
            <div class="zs-footer-social">
              <a href="https://github.com/Dheeps02/xcaliber" target="_blank" rel="noopener" class="zs-footer-icon" aria-label="GitHub">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 256 256" aria-hidden="true"><path d="M208.31 75.68A59.78 59.78 0 0 0 202.93 28a8 8 0 0 0-6.93-4 59.75 59.75 0 0 0-48 24h-24a59.75 59.75 0 0 0-48-24 8 8 0 0 0-6.93 4 59.78 59.78 0 0 0-5.38 47.68A58.14 58.14 0 0 0 56 104v8a56.06 56.06 0 0 0 48.44 55.47A39.8 39.8 0 0 0 96 192v8H72a24 24 0 0 1-24-24 40 40 0 0 0-40-40 8 8 0 0 0 0 16 24 24 0 0 1 24 24 40 40 0 0 0 40 40h24v16a8 8 0 0 0 16 0v-40a24 24 0 0 1 48 0v40a8 8 0 0 0 16 0v-40a39.8 39.8 0 0 0-8.44-24.53A56.06 56.06 0 0 0 216 112v-8a58.14 58.14 0 0 0-7.69-28.32Z"/></svg>
              </a>
            </div>
          </div>
...
.zs-root {
  --zs-accent: #10b981;
  --zs-accent-2: color-mix(in oklab, var(--zs-accent), white 28%);
  --zs-accent-3: color-mix(in oklab, var(--zs-accent), black 28%);
  --zs-aurora-op: 0.50;
  --zs-text: #ECEAF3;
  --zs-muted: #9b94ad;
  --zs-faint: #6a6380;
  ...
  background: radial-gradient(1200px 700px at 80% -10%, rgba(16,185,129,0.08), transparent 60%), #060c0a;
  color: var(--zs-text);
  min-height: 100vh;
  overflow-x: hidden;
  position: relative;
...
.zs-container { max-width: 1160px; margin: 0 auto; padding: 0 32px; }
...
.zs-logo-name { font-family: 'JetBrains Mono', monospace; font-size: 15px; letter-spacing: -0.02em; color: var(--zs-text); font-weight: 500; }
.zs-nav-links { display: flex; align-items: center; gap: 2px; flex: 1; }
.zs-nav-link {
  display: inline-flex; align-items: center; gap: 6px;
  font-size: 14px; color: var(--zs-muted); text-decoration: none;
  padding: 6px 12px; border-radius: 6px; transition: color 0.15s;
}
.zs-nav-link:hover { color: var(--zs-text); }
.zs-nav-actions { display: flex; align-items: center; gap: 10px; }
.zs-star {
  display: flex; align-items: center; gap: 7px;
  font-size: 13px; color: var(--zs-muted); text-decoration: none;
  padding: 6px 14px; border: 1px solid var(--zs-border); border-radius: 8px;
...
.zs-btn-download {
  ...
  text-decoration: none; padding: 7px 16px; border-radius: 8px; transition: box-shadow 0.2s;
}
.zs-btn-download:hover { box-shadow: 0 9px 30px rgba(16,185,129,0.45); }
...
.zs-aurora { position: absolute; inset: 0; z-index: 1; pointer-events: none; overflow: hidden; }
.zs-aurora-blob { position: absolute; border-radius: 50%; filter: blur(70px); }
.zs-aurora-blob-1 {
  width: 65vw; height: 55vh; top: -15%; left: -10%;
  background: radial-gradient(ellipse, rgba(16,185,129,var(--zs-aurora-op)), transparent 70%);
  animation: zs-drift1 24s ease-in-out infinite;
}
.zs-aurora-blob-2 {
  width: 55vw; height: 50vh; top: 5%; right: -15%;
  background: radial-gradient(ellipse, rgba(4,120,87,calc(var(--zs-aurora-op)*0.75)), transparent 70%);
  animation: zs-drift2 30s ease-in-out infinite;
}
.zs-aurora-blob-3 {
  width: 45vw; height: 40vh; bottom: -10%; left: 25%;
  background: radial-gradient(ellipse, rgba(110,231,183,calc(var(--zs-aurora-op)*0.40)), transparent 70%);
...
.zs-btn-primary {
  display: inline-flex; align-items: center; gap: 8px;
  font-size: 15px; font-weight: 600; color: #000; background: var(--zs-accent);
  text-decoration: none; padding: 12px 28px; border-radius: 10px;
  transition: transform 0.2s, box-shadow 0.2s;
  box-shadow: 0 6px 24px rgba(16,185,129,0.30);
}
.zs-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 14px 42px rgba(16,185,129,0.48); }
.zs-btn-sm { padding: 9px 20px; font-size: 14px; }
.zs-btn-ghost {
  display: inline-flex; align-items: center; gap: 8px;
  font-size: 15px; font-weight: 500; color: var(--zs-muted); background: transparent;
...
.zs-copy-btn {
  ...
  font-size: 12px; font-family: 'JetBrains Mono', monospace; color: var(--zs-faint);
  background: transparent; border: 1px solid transparent; border-radius: 5px;
  padding: 3px 8px; cursor: pointer; transition: border-color 0.15s, color 0.15s;
}
.zs-copy-btn:hover { border-color: rgba(16,185,129,0.45); color: #fff; }

/* ── Showcase ── */
.zs-showcase { padding: 0 0 100px; }
.zs-showcase-split { padding: 80px 0 100px; border-top: 1px solid var(--zs-border); }
.zs-showcase-split-inner { display: flex; gap: 64px; align-items: center; }
...
.zs-window-chrome {
  background: var(--zs-panel); border: 1px solid var(--zs-border);
  border-radius: 14px; overflow: hidden; box-shadow: 0 32px 80px rgba(0,0,0,0.5);
}
.zs-window-chrome-side { flex: 1.5; }
.zs-window-chrome-bar {
  display: flex; align-items: center; gap: 7px; padding: 12px 16px;
  background: rgba(255,255,255,0.03); border-bottom: 1px solid var(--zs-border);
}
.zs-chrome-dot { width: 12px; height: 12px; border-radius: 50%; background: rgba(255,255,255,0.12); flex-shrink: 0; }
.zs-chrome-title { font-size: 12px; font-family: 'JetBrains Mono', monospace; color: var(--zs-faint); margin-left: 8px; }
.zs-img-placeholder {
  aspect-ratio: 16/9; display: flex; align-items: center;
  justify-content: center; background: rgba(255,255,255,0.02);
}
.zs-placeholder-inner { display: flex; flex-direction: column; align-items: center; gap: 10px; color: var(--zs-faint); font-size: 14px; }
.zs-placeholder-hint { font-family: 'JetBrains Mono', monospace; font-size: 11px; color: var(--zs-faint); opacity: 0.55; }
...
.zs-section-eyebrow {
  ...
  color: var(--zs-accent-2); margin-bottom: 12px;
}
.zs-section-title {
  font-family: 'Cormorant Garamond', serif;
  font-size: clamp(32px, 4vw, 54px); font-weight: 500;
  letter-spacing: -0.025em; line-height: 1.1; color: var(--zs-text); margin-bottom: 16px;
}
.zs-section-sub { font-size: 17px; line-height: 1.65; color: var(--zs-muted); max-width: 580px; margin-bottom: 52px; }

/* ── Features ── */
.zs-features { padding: 100px 0; border-top: 1px solid var(--zs-border); }
.zs-features .zs-container { text-align: center; }
.zs-features .zs-section-eyebrow { justify-content: center; }
.zs-features .zs-section-sub { margin: 0 auto 52px; }
.zs-features-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; text-align: left; }
...
.zs-feature-card:hover {
  border-color: rgba(16,185,129,0.40); transform: translateY(-4px);
  box-shadow: 0 16px 40px rgba(16,185,129,0.08);
}
.zs-feature-card:active { transform: translateY(-1px) scale(0.99); }

.zs-feature-icon {
  width: 44px; height: 44px;
  background: rgba(16,185,129,0.10); border: 1px solid rgba(16,185,129,0.18);
  border-radius: 10px; display: flex; align-items: center; justify-content: center;
  color: var(--zs-accent-2); margin-bottom: 16px;
...
.zs-feature-desc code {
  ...
  color: var(--zs-accent-2); background: rgba(16,185,129,0.1); padding: 1px 5px; border-radius: 3px;
}

/* ── Architecture ── */
.zs-arch { padding: 100px 0; border-top: 1px solid var(--zs-border); }
.zs-arch-diagram {
  display: flex; align-items: stretch; gap: 0;
  margin: 52px 0 32px; overflow-x: auto; padding-bottom: 8px;
}
.zs-arch-box {
  flex: 1; min-width: 200px; border: 1px solid var(--zs-border);
  border-radius: 14px; padding: 24px; background: var(--zs-panel);
}
.zs-arch-box-ui  { border-color: rgba(16,185,129,0.25); }
.zs-arch-box-core { border-color: rgba(16,185,129,0.55); background: rgba(16,185,129,0.05); }
.zs-arch-box-ecu  { border-color: rgba(16,185,129,0.18); }
.zs-arch-box-header {
  display: flex; align-items: center; gap: 8px;
  margin-bottom: 16px; flex-wrap: wrap;
}
.zs-arch-box-header svg { color: var(--zs-accent-2); flex-shrink: 0; }
.zs-arch-label { font-size: 13px; font-weight: 600; color: var(--zs-text); }
.zs-arch-lang { font-family: 'JetBrains Mono', monospace; font-size: 10px; color: var(--zs-faint); margin-left: auto; }
.zs-arch-items { display: flex; flex-direction: column; gap: 6px; }
.zs-arch-item {
  font-family: 'JetBrains Mono', monospace; font-size: 11px;
  color: var(--zs-muted); background: rgba(255,255,255,0.04);
  border: 1px solid rgba(255,255,255,0.06); border-radius: 5px; padding: 4px 10px;
}
.zs-arch-item-accent { color: var(--zs-accent-2); background: rgba(16,185,129,0.07); border-color: rgba(16,185,129,0.14); }
.zs-arch-arrow-col {
  display: flex; flex-direction: column; align-items: center;
  justify-content: center; gap: 12px; padding: 0 16px; flex-shrink: 0;
}
.zs-arch-conn { display: flex; flex-direction: column; align-items: center; gap: 3px; color: var(--zs-faint); }
.zs-arch-conn-label { font-family: 'JetBrains Mono', monospace; font-size: 10px; color: var(--zs-faint); white-space: nowrap; }
.zs-link-underline {
  font-size: 14px; color: var(--zs-accent-2); text-decoration: none;
  border-bottom: 1px solid rgba(16,185,129,0.30); padding-bottom: 1px;
  transition: color 0.15s, border-color 0.15s;
}
.zs-link-underline:hover { color: #fff; border-color: rgba(16,185,129,0.65); }

/* ── API ── */
.zs-api { padding: 100px 0; border-top: 1px solid var(--zs-border); }
.zs-api-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: start; }
.zs-api-copy .zs-section-sub { margin-bottom: 24px; }
.zs-api-table { width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 24px; }
.zs-api-table th {
  font-family: 'JetBrains Mono', monospace; font-size: 11px;
  text-transform: uppercase; letter-spacing: 0.08em; color: var(--zs-faint);
  padding: 8px 12px; text-align: left; border-bottom: 1px solid var(--zs-border);
}
.zs-api-table td { padding: 10px 12px; color: var(--zs-muted); border-bottom: 1px solid rgba(255,255,255,0.04); vertical-align: middle; }
.zs-api-table td code { font-family: 'JetBrains Mono', monospace; font-size: 12px; color: var(--zs-text); }
...
/* ── Themes ── */
.zs-themes { padding: 80px 0; border-top: 1px solid var(--zs-border); overflow: hidden; }
.zs-themes-header { text-align: center; margin-bottom: 12px; }
.zs-themes-header .zs-section-eyebrow { justify-content: center; }
.zs-themes-header .zs-section-title { margin-bottom: 8px; }
.zs-themes-sub { font-size: 16px; color: var(--zs-muted); text-align: center; margin-bottom: 40px; }
.zs-marquee-wrap {
  overflow: hidden;
...
.zs-marquee {
  ...
  animation: zs-marquee 36s linear infinite;
}
.zs-marquee:hover { animation-play-state: paused; }
.zs-theme-chip {
  display: inline-flex; align-items: center; gap: 10px;
  background: color-mix(in srgb, var(--chip-bg) 90%, transparent);
  border: 1px solid color-mix(in srgb, var(--chip-bg), white 18%);
  border-radius: 10px; padding: 10px 18px; margin: 0 8px;
  white-space: nowrap; user-select: none;
}
.zs-theme-swatches { display: flex; gap: 4px; flex-shrink: 0; }
.zs-theme-swatch { width: 10px; height: 10px; border-radius: 50%; flex-shrink: 0; }
.zs-theme-name { font-family: 'JetBrains Mono', monospace; font-size: 12.5px; color: var(--chip-fg); }

/* ── Quickstart ── */
.zs-quickstart { padding: 100px 0; border-top: 1px solid var(--zs-border); }
.zs-qs-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 48px; margin-top: 52px; }
.zs-qs-num { font-family: 'Cormorant Garamond', serif; font-size: 56px; font-weight: 500; color: rgba(16,185,129,0.2); line-height: 1; margin-bottom: 14px; }
...
/* ── Built For ── */
.zs-built-for { padding: 100px 0; border-top: 1px solid var(--zs-border); }
.zs-bf-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin: 52px 0 32px; }
.zs-bf-card {
  display: block; text-decoration: none;
  background: var(--zs-panel); border: 1px solid var(--zs-border);
...
.zs-bf-card:hover { border-color: rgba(16,185,129,0.40); transform: translateY(-3px); }
.zs-bf-icon {
  width: 52px; height: 52px; background: rgba(16,185,129,0.10);
  border: 1px solid rgba(16,185,129,0.18); border-radius: 12px;
  display: flex; align-items: center; justify-content: center;
  color: var(--zs-accent-2); margin-bottom: 18px;
  transition: background 0.2s, border-color 0.2s, transform 0.2s;
}
.zs-bf-card:hover .zs-bf-icon { background: rgba(16,185,129,0.18); border-color: rgba(16,185,129,0.40); transform: scale(1.08) rotate(5deg); }
.zs-bf-card h3 { font-size: 17px; font-weight: 600; color: var(--zs-text); margin-bottom: 10px; letter-spacing: -0.01em; }
.zs-bf-card p { font-size: 14px; line-height: 1.65; color: var(--zs-muted); margin-bottom: 16px; }
.zs-bf-link { font-size: 13px; color: var(--zs-accent-2); }

/* ── Tech Stack ── */
.zs-stack { padding: 80px 0; border-top: 1px solid var(--zs-border); }
.zs-stack-pills { display: flex; flex-wrap: wrap; gap: 10px; margin: 28px 0 24px; }
.zs-stack-pill {
  font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--zs-muted);
  background: rgba(255,255,255,0.04); border: 1px solid var(--zs-border); border-radius: 7px; padding: 7px 16px;
}

/* ── CTA ── */
.zs-cta { padding: 120px 0; border-top: 1px solid var(--zs-border); }
.zs-cta-inner {
  position: relative; text-align: center; isolation: isolate;
  padding: 80px 40px; border: 1px solid rgba(16,185,129,0.18);
  border-radius: 24px; overflow: hidden;
}
.zs-cta-aurora { position: absolute; inset: 0; z-index: -1; pointer-events: none; }
.zs-cta-aurora .zs-aurora-blob-1 { width: 60%; height: 80%; top: -20%; left: -10%; opacity: 0.4; }
.zs-cta-aurora .zs-aurora-blob-2 { width: 50%; height: 70%; top: -10%; right: -10%; opacity: 0.35; }
.zs-cta-title {
  font-family: 'Cormorant Garamond', serif; font-size: clamp(36px, 5vw, 64px);
  font-weight: 500; letter-spacing: -0.03em; line-height: 1.1; color: var(--zs-text); margin-bottom: 16px;
}
.zs-cta-sub { font-size: 17px; color: var(--zs-muted); margin: 0 auto 36px; max-width: 480px; }
.zs-cta-btns { display: flex; align-items: center; gap: 14px; justify-content: center; flex-wrap: wrap; }

/* ── Footer ── */
.zs-footer { padding: 60px 0 40px; border-top: 1px solid var(--zs-border); }
.zs-footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 48px; margin-bottom: 48px; }
...
.zs-footer-bottom {
  ...
  flex-wrap: wrap; gap: 8px; padding-top: 24px; border-top: 1px solid var(--zs-border);
}
.zs-footer-copy { font-size: 13px; color: var(--zs-faint); }

/* ── Keyframes ── */
@keyframes zs-drift1 { 0%,100% { transform:translate(0,0) scale(1); } 50% { transform:translate(7vw,4vh) scale(1.18); } }
@keyframes zs-drift2 { 0%,100% { transform:translate(0,0) scale(1.05); } 50% { transform:translate(-6vw,5vh) scale(1.2); } }
@keyframes zs-drift3 { 0%,100% { transform:translate(0,0) scale(1); } 50% { transform:translate(4vw,-5vh) scale(1.22); } }
@keyframes zs-fadeup { from { opacity:0; transform:translateY(16px); } to { opacity:1; transform:translateY(0); } }
@keyframes zs-blink { 0%,100% { opacity:1; } 50% { opacity:0.3; } }
...
@media (prefers-reduced-motion: reduce) {
  ...
  .zs-hero-title, .zs-hero-sub, .zs-hero-ctas, .zs-badge, .zs-quickstart-cmd, .zs-xcp-pill { animation: none !important; }
}
...
@media (max-width: 960px) {
  ...
  .zs-arch-diagram { flex-direction: column; }
  .zs-arch-arrow-col { flex-direction: row; padding: 8px 0; }
